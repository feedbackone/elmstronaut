 ...
 */
export const BOOTSTRAP_SCRIPT_PATH = path.join(import.meta.dirname, "static", "bootstrap.js")
 ...
 */
export const ELMSTRONAUT_D_TS_PATH = path.join(import.meta.dirname, "static", "elmstronaut.d.ts")
